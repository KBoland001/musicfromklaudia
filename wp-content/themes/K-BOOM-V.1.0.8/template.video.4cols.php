            ...
            <div id="white-background">
                ...
                <div id="content" class="container clearfix" style="padding-bottom: 20px;">
                    ...
                    <ul class="filterable" id="<?php echo of_get_option('sc_portfoliofilters')=='javascript' ? 'filterable' : '' ?>">
                        ...
                        <li><a href="<?php echo get_term_link($category->slug, 'collections') ?>" class="<?php echo $category->category_nicename;?>" data-type="<?php echo $category->category_nicename;?>"><?php echo $category->name;?></a></li>
                        <?php }?>
